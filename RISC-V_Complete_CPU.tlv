...
\TLV
   ...
   // Extraction of non-immediate instruction fields
   ...
   // Determination of the validity of fields
   
   `BOGUS_USE($funct3_valid $funct7_valid $imm_valid) // To silence warnings
